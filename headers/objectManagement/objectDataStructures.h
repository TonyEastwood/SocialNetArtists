...
struct Line3d  // line that contain index on vertex that form it (index mean
               // index in vertex array)
{
  ...
  bool operator==(const Line3d _element) const {
    return (indexVertex1 == _element.indexVertex1 &&
            indexVertex2 == _element.indexVertex2);
  }
};
