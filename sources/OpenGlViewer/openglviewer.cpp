...
void OpenGlViewer::paintGL() {
  ...
  glOrtho(-scaleWheel * drawObject.getMaxOriginAxis().x,
          scaleWheel * drawObject.getMaxOriginAxis().x,
          scaleWheel * drawObject.getMaxOriginAxis().y,
          -scaleWheel * drawObject.getMaxOriginAxis().y,
          -scaleWheel * drawObject.getMaxOriginAxis().z,
          scaleWheel * drawObject.getMaxOriginAxis()
                           .z);  // set matrix scope. Need get opportunity to
                                 // scale (zoom in\out)
