...
Object3d::Object3d() { objectName = "default"; }
...
/*!
     \brief get header info.
      ...
      detail...
 */
QByteArray Object3d::getName() const { return objectName; }
/*!
     \brief set header info.

      detail...
 */
void Object3d::setObjectName(const QByteArray &value) { objectName = value; }

unsigned int Object3d::getQuantityVertex3d() const {
  return vertex3dData.size();
}

unsigned int Object3d::getQuantityLines3d() const { return lines3dData.size(); }
/*!
...
unsigned int Object3d::getQuantityFaces3d() const { return faces3dData.size(); }
